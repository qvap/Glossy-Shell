...
Item {
    ...
    Rectangle {
        ...
        gradient: Gradient {
            GradientStop { position: 0.0; color: Qt.hsla(root.mainColor.hslHue, root.mainColor.hslSaturation, 0.8, 0.8) }
            GradientStop { position: 1.0; color: Qt.hsla(root.mainColor.hslHue, root.mainColor.hslSaturation, 0.7, 0.4) }
        }
        opacity: 0.9
        border {
